...
import { TOOL_DEFINITIONS, executeToolByName } from './helpers/toolRegistry';
...
export class ChatbotService {
   ...
   *
   * 1. Sends the user prompt to Claude with available tools.
   * 2. Handles Claude's tool_use blocks in a loop (multi-step reasoning).
   * 3. Returns the final conversational response.
   */
  async chat(
    userId: string,
    accessToken: string,
