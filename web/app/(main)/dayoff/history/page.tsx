...
export default function ApplicationHistoryPage() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      console.error("Failed loading leave applications history:", err);
    } finally {
      setLoading(false);
    }
  }, [isEnabled, year]);
    ...
    <div className="flex flex-col h-screen overflow-hidden bg-background">
      <PageHeader
        ...
        breadcrumbs={[
          ...
          { label: "My Leaves", href: "/dayoff/requests" },
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-card p-4 rounded-2xl border border-border/60 shadow-xs">
            ...
            <div className="flex items-center gap-2 self-end sm:self-auto">
              ...
              <button
                ...
                className="px-3 py-1.5 text-xs font-semibold text-muted-foreground hover:text-foreground hover:bg-muted/80 rounded-xl border border-border transition-colors cursor-pointer"
              >
                Current Year
              </button>
            </div>
          ...
          {/* Applications List View Table Only */}
            ...
            {loading ? (
              ...
              <div className="py-20 text-center text-sm text-muted-foreground space-y-3">
                ...
                <button
                  ...
                  className="mt-2 inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-semibold bg-primary text-primary-foreground hover:bg-primary/90 transition-colors shadow-xs cursor-pointer"
                >
                  Apply for Leave
                </button>
              </div>
